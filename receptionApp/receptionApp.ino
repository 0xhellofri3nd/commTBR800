...
byte sb;   
byte pkgRead[400];      
// byte pkgWrite[ ] = {5,100,11, 196,3,0,1,0,107,230,192,192,1,60,1,6,255,80}; // Em DEC
//byte pkgWrite[ ] = {0x05,0x64,0x0b,0xc4,0x03,0x00,0x01,0x00,0x6b,0xe6,0xc0,0xc0,0x01,0x3c,0x01,0x06,0xff,0x50};
byte pkgWrite[ ] = {5, 100, 16, 196, 3, 0, 1, 0, 38, 151, 192 ,192, 5, 41, 2, 23,  1, 2, 45, 0, 0 ,47, 104 };
void setup () {
    Serial.begin(9600);
    pinMode(btn, INPUT);
